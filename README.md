Want JSON-encoded data on films? You won't get it from the [IMDb](http://www.imdb.com), and third-party solutions like the [OMDb API](https://www.omdbapi.com/) provide limited search capabilities.  
